    ...
    <section id="featured-properties" className="py-16 bg-indigo-100">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold text-indigo-800 mb-2">تعمیرات ویژه</h2>
          <div className="w-24 h-1 bg-indigo-500 mx-auto rounded-full"></div>
          <p className="text-indigo-500 mt-4">پرتقاضاترین خدمات تعمیرات در ماه اخیر</p>
        </div>
